...
# Method 2: Feature selection using Feature Agglomeration
...
# Method 3: Feature selection using HVGS (High Variance Gene Selection)
def method_hvgs(X, y):
...
def main():
    ...
    # Method 3: Feature selection using HVGS
