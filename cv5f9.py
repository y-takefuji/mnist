...
print(f"Top {k_features} features from PCA:")
...
print(f"Top {k_features} features from HVGs:")
for feature in hvgs_features:
    print(f"- {feature}")

# 5. Random Forest Feature Selection (RF-RF)
print("\n===== Random Forest Feature Selection =====")
def rf_feature_selection(X, y, top_n=9):
...
print(f"Top {k_features} features from Random Forest:")
...
print("Top 9 features from", best_method, ":", best_feats)
